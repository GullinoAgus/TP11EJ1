...
int main(int argc, char** argv) {
    ...
    al_draw_bitmap(textura[Q_BUTTON], 790, 10, 0);
    
    
    char* fontPath = "resources/fonts/Avenir_Next.ttc";
    font = al_load_font(fontPath, 20, 0);
    if (!font) {
    ...
    al_draw_text(font, al_map_rgb(0, 0, 0), 540, 290, 0, "Apagar");
    al_draw_text(font, al_map_rgb(0, 0, 0), 540, 350, 0, "Encender");
    al_draw_text(font, al_map_rgb(0, 0, 0), 705, 290, 0, "Parpadear");
    al_draw_text(font, al_map_rgb(0, 0, 0), 705, 350, 0, "Invertir");
